...
namespace Leguar.TotalJSON
{
    ...
    public class JArray : JValue
    {
        ...
        ///
        /// When you want to get all content of this JArray object in JSON formatted string, use <see cref="CreateString()"/>.
        /// </summary>
        /// <returns>
        ...
        ///
        /// Note that for large JArray objects output may be also very long. For debugging purposes, consider also <see cref="ToString()"/>.
        /// </summary>
        /// <returns>
